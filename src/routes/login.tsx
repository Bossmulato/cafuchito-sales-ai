      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-gold/30 bg-card/80 p-8 shadow-luxe backdrop-blur">
          ...
          <div className="my-5 flex items-center gap-3 text-xs uppercase tracking-wider text-muted-foreground">
            <div className="h-px flex-1 bg-gold/20" /> ou <div className="h-px flex-1 bg-gold/20" />
          </div>
          <button
            type="button"
            onClick={async () => {
              try {
                ...
                if (result.error) throw new Error(result.error.message ?? "Erro Google");
            ...
            className="flex w-full items-center justify-center gap-3 rounded-md border border-gold/40 bg-card/60 py-3 font-medium text-foreground hover:border-primary hover:bg-card transition"
          >
